...
ActiveRecord::Schema.define(version: 2021_06_27_145627) do
  ...
  create_table "characters_starships", id: false, force: :cascade do |t|
    t.bigint "character_id", null: false
    t.bigint "starship_id", null: false
  end

  create_table "characters_vehicles", id: false, force: :cascade do |t|
    t.bigint "character_id", null: false
